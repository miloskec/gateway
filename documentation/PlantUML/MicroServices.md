...
### **If your all project branches are set to the production-prepare you will only need to follow instructions from the https://github.com/miloskec/gateway/blob/production-prepare/README.md**
